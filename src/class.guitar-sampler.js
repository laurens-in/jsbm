class GuitarSampler {
    ...
    constructor(volume, distortion, panning, baseurl = "./assets/samples/") {
        ...
        this.guitar1 = new Tone.Sampler({
            ...
            'A#2': "Guitar/Guitar_A#2_-_1.opus",
            'C#3': "Guitar/Guitar_C#3_-_1.opus",
            'E3' : "Guitar/Guitar_E3_-_1.opus",
            'A#3': "Guitar/Guitar_A#3_-_1.opus",
            'E4' : "Guitar/Guitar_E4_-_1.opus",
            'A#4': "Guitar/Guitar_A#4_-_1.opus",
        ...
        this.guitar2 = new Tone.Sampler({
            ...
            'A#2': "Guitar/Guitar_A#2_-_2.opus",
            'C#3': "Guitar/Guitar_C#3_-_2.opus",
            'E3' : "Guitar/Guitar_E3_-_2.opus",
            'A#3': "Guitar/Guitar_A#3_-_2.opus",
            'E4' : "Guitar/Guitar_E4_-_2.opus",
            'A#4': "Guitar/Guitar_A#4_-_2.opus",
        ...
        this.guitar3 = new Tone.Sampler({
            ...
            'A#2': "Guitar/Guitar_A#2_-_3.opus",
            'C#3': "Guitar/Guitar_C#3_-_3.opus",
            'E3' : "Guitar/Guitar_E3_-_3.opus",
            'A#3': "Guitar/Guitar_A#3_-_3.opus",
            'E4' : "Guitar/Guitar_E4_-_3.opus",
            'A#4': "Guitar/Guitar_A#4_-_3.opus",
        ...
        this.guitar4 = new Tone.Sampler({
            ...
            'A#2': "Guitar/Guitar_A#2_-_4.opus",
            'C#3': "Guitar/Guitar_C#3_-_4.opus",
            'E3' : "Guitar/Guitar_E3_-_4.opus",
            'A#3': "Guitar/Guitar_A#3_-_4.opus",
            'E4' : "Guitar/Guitar_E4_-_4.opus",
            'A#4': "Guitar/Guitar_A#4_-_4.opus",
        ...
        this.guitar5 = new Tone.Sampler({
            ...
            'A#2': "Guitar/Guitar_A#2_-_5.opus",
            'C#3': "Guitar/Guitar_C#3_-_5.opus",
            'E3' : "Guitar/Guitar_E3_-_5.opus",
            'A#3': "Guitar/Guitar_A#3_-_5.opus",
            'E4' : "Guitar/Guitar_E4_-_5.opus",
            'A#4': "Guitar/Guitar_A#4_-_5.opus",
        ...
        this.guitar6 = new Tone.Sampler({
            ...
            'A#2': "Guitar/Guitar_A#2_-_6.opus",
            'C#3': "Guitar/Guitar_C#3_-_6.opus",
            'E3' : "Guitar/Guitar_E3_-_6.opus",
            'A#3': "Guitar/Guitar_A#3_-_6.opus",
            'E4' : "Guitar/Guitar_E4_-_6.opus",
            'A#4': "Guitar/Guitar_A#4_-_6.opus",
        ...
        this.guitar7 = new Tone.Sampler({
            ...
            'A#2': "Guitar/Guitar_A#2_-_7.opus",
            'C#3': "Guitar/Guitar_C#3_-_7.opus",
            'E3' : "Guitar/Guitar_E3_-_7.opus",
            'A#3': "Guitar/Guitar_A#3_-_7.opus",
            'E4' : "Guitar/Guitar_E4_-_7.opus",
            'A#4': "Guitar/Guitar_A#4_-_7.opus",
        ...
        this.guitar8 = new Tone.Sampler({
            ...
            'A#2': "Guitar/Guitar_A#2_-_8.opus",
            'C#3': "Guitar/Guitar_C#3_-_8.opus",
            'E3' : "Guitar/Guitar_E3_-_8.opus",
            'A#3': "Guitar/Guitar_A#3_-_8.opus",
            'E4' : "Guitar/Guitar_E4_-_8.opus",
            'A#4': "Guitar/Guitar_A#4_-_8.opus",
